        ...
        setContent {
            AppTheme(theme = application.currentTheme.value) {
                WeatherApp(onToggleTheme = { application.changeTheme(Theme.Light)},
                    onToggleDarkMode = { application.changeTheme(Theme.Dark)},musicServiceConnection = musicServiceConnection)
            }
...
fun WeatherApp(
    ...
    musicServiceConnection: MusicServiceConnection
               ...
               Column(verticalArrangement = Arrangement.Center,
                   ...
                   MainScreen(navController = navController, onToggleTheme = onToggleTheme, onToggleDarkMode = onToggleDarkMode, musicServiceConnection = musicServiceConnection)
               }
}
